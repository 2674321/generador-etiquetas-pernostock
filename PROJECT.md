...
`v1.6.2` (reconstrucción con correcciones + selección de hoja + CSV + progreso y
...
verificada headful + **feedback visual con documentos grandes (spinner y barra
de progreso "N de M · seg") y zona de resultados con expansión vertical**).
Histórico original: versión no determinada (variantes
